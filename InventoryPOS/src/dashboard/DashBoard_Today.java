 ...
 * @author Cor2Tect
 */
public class DashBoard_Today extends javax.swing.JFrame {

    public DBGateway dbg;
    Connection connection = null;
    /**
     * Creates new form DashBoard_Today
     */
    ...
    public void ShowReport()
    {
        ...
        String from = "'"+date+"'";
        //JOptionPane.showMessageDialog(this,"Time = "+ time+"Date = "+ from);
            ...
            while (rs.next()) {
                ...
                try {
                    ...
                    while (rs1.next()) {
                        ...
                        System.out.println("Sum = "+rs1.getString(1));
        ...
        double TP = 0.0, p = 0.0,_vat = 0.0, _discount = 0.0, _due = 0.0, _dueCollection = 0.0;
        ...
        jTable2.setValueAt("                 Due(-)          =", RowNo+3, 0);
        //
                ...
                try {
                    ...
                    // print the results
                    while (rs6.next()) {
                        jTable2.setValueAt(rs6.getString(1), RowNo+3, 1);
                ...
                jTable2.setValueAt("   Due Collection(+)       =", RowNo + 4, 0);
            //
            ...
            try {
                ...
                // print the results
                while (rs7.next()) {
                    jTable2.setValueAt(rs7.getString(1), RowNo + 4, 1);
        ...
        //Double vat = Double.parseDouble(String.valueOf(jTable2.getValueAt(RowNo+1, 1)));
            //Double discount = Double.parseDouble(String.valueOf(jTable2.getValueAt(RowNo+2, 1)));
            Double grossTP = TP + _vat - _discount - _due + _dueCollection;
                
        jTable2.setValueAt("                 Total                =", RowNo+5, 0);
        jTable2.setValueAt(grossTP, RowNo+5, 1);
        
        jTable2.setValueAt("    Advance Salary         =", RowNo+6, 0);
        double adv = 0.0;
        java.sql.Statement stm5 = null;
                ...
                try {
                    ...
                    // print the results
                    while (rs5.next()) {
                        jTable2.setValueAt(rs5.getString(1), RowNo+6, 1);
        ...
        jTable2.setValueAt("         Gross Total            =", RowNo+7, 0);
        jTable2.setValueAt(grossTP1, RowNo+7, 1);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Today's Sells Report");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashBoard_Today.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
