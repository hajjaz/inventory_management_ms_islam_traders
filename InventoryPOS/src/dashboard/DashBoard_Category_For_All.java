 ...
 */
public class DashBoard_Category_For_All extends javax.swing.JFrame {
     ...
     */
    public DashBoard_Category_For_All() {
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT item_name,item_quantity from inv_item where cat_id = "+cat_id+"");
            // print the results
            while (rs.next()) {
...
//            jTable2.setValueAt(TP, RowNo, 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashBoard_Category_For_All.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
