 ...
 */
public class DashBoard_Category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Quantity", "Sell Amount", "Balance Item Quantity", "Balance Buying Amount", "Balance Selling Amount", "Balance Retailer Selling Amount"
            }
        ) {
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        if (jComboBox1.getSelectedIndex() == -1) {
            ...
            Double balanceByingAmount = 0.0, balanceSellingAmount = 0.0, balanceRetailerSellingAmount = 0.0;
            java.sql.Statement stm = null;
            ResultSet rs = null;
            try {
                stm = connection.createStatement();
                rs = stm.executeQuery("SELECT item_name, item_quantity, item_price, item_selling_price, item_retailer_price from inv_item where cat_id = " + cat_id + "");
                // print the results
                while (rs.next()) {
                    Double buyingAmount = 0.0, sellingAmount = 0.0, retailerSellingAmount = 0.0;
                    jTable2.setValueAt(rs.getString("item_name"), RowNo, 0);
                    jTable2.setValueAt(rs.getString("item_quantity"), RowNo, 3);
                    Double dtk = Double.parseDouble(rs.getString("item_price"));
                    buyingAmount += dtk * Integer.parseInt(rs.getString("item_quantity"));
                    balanceByingAmount += buyingAmount;
                    jTable2.setValueAt(buyingAmount, RowNo, 4);

                    sellingAmount += Double.parseDouble(rs.getString("item_selling_price")) * Integer.parseInt(rs.getString("item_quantity"));
                    balanceSellingAmount += sellingAmount;
                    jTable2.setValueAt(sellingAmount, RowNo, 5);

                    retailerSellingAmount += Double.parseDouble(rs.getString("item_retailer_price")) * Integer.parseInt(rs.getString("item_quantity"));
                    balanceRetailerSellingAmount += retailerSellingAmount;
                    jTable2.setValueAt(retailerSellingAmount, RowNo, 6);
                    ...
                    try {
                        ...
                        rs1 = stm1.executeQuery("SELECT sum(item_quantity),sum(sell_price) FROM inv_transaction where cat_name = " + catName + " "
                                + "and item_name = " + itemName + " and to_date(tran_date) between to_date(" + from + ") "
                                + "and to_date(" + to + ")");
                        // print the results
                        while (rs1.next()) {
                            jTable2.setValueAt(rs1.getString(1), RowNo, 1);
                            jTable2.setValueAt(rs1.getString(2), RowNo, 2);
            ...
            jTable2.setValueAt("              Total              =", RowNo + 1, 1);
            jTable2.setValueAt(TP, RowNo + 1, 2);

            jTable2.setValueAt("              Total              =", RowNo + 1, 3);
            jTable2.setValueAt(balanceByingAmount, RowNo + 1, 4);

            jTable2.setValueAt(balanceSellingAmount, RowNo + 1, 5);

            jTable2.setValueAt(balanceRetailerSellingAmount, RowNo + 1, 6);
            /*
            //gross total
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashBoard_Category.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
