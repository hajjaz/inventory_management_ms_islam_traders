 ...
 * @author HajjazPC
 */
public class Admin_Add_Category extends javax.swing.JFrame {
   ...
   public DBGateway dbg;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            try {
                statement = connection.prepareStatement("INSERT INTO inv_category (Cat_Id,Cat_Name, Cat_Picture)VALUES (?, ?, ?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Add_Category.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
