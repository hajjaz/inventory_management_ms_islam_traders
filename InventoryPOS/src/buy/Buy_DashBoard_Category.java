 ...
 */
public class Buy_DashBoard_Category extends javax.swing.JFrame {
        ...
        if(fl==1){
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        stm1 = connection.createStatement();
                        rs1 = stm1.executeQuery("SELECT sum(item_quantity) FROM buy_transaction where cat_name = " + catName + " "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buy_DashBoard_Category.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
